...
const SalesView = () => {
    const { Sales, deleteSale } = useSaleContext();

    const handleExport = () => {
        exportToPDF(Sales, 'Usuarios', ['name', 'lastname', 'email', 'age']);
    };
    ...
    return (
        <div className="p-4">
            ...
            <DataTable value={Array.isArray(Sales) ? Sales : []} paginator={false} className="p-datatable-sm p-shadow-2 mt-4">
